...
function get-net{
    ...
    Write-Output "---------------------------"
    $net = get-ciminstance Win32_NetworkAdapterConfiguration | where IPenabled -eq True | ft -Autosize Index, IPSubnet, DNSDomain, DNSServerSearchOrder, Description, IPAddress
